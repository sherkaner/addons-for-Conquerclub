...
'</fieldset><!-- end GAMEPLAY --><div style="position:fixed;top:55px;text-align:right;width:570px;"><strong><a href="javascript:void(0)" id="close-user-guide" style="background:#eeffee;">[x]</a></strong></div></div>';
	...
	function refreshMap() {
		var x = document.getElementById('right_hand_side').getElementsByTagName("a");
		for (var i = 0; i < x.length; i++) {
			if (x[i].textContent.indexOf("refresh") > -1) {
	...
	function doUpgrade() {
		...
		link.href = "http://userscripts.org/scripts/source/64539.user.js";
	}
